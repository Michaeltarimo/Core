  ...
  return (
    <div className="flex flex-col w-full overflow-x-auto">
        <div className="flex flex-col items-center justify-center">
            <h1 className="font-semibold text-3xl">Most Trending</h1>
            <p className="font-semibold sm:text-sm sm:text-center text-gray-500">Startups which have raised much money in few days</p>
        </div>

        <div className="flex flex-row lg:flex-col items-center gap-12 p-4 overflow-x-auto">
